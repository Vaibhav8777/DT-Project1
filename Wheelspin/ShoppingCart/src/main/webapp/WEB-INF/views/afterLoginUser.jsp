      ...
      <li class="divider-vertical"></li>
		<c:if test="${pageContext.request.userPrincipal.name != null}">
			...
			<c:if test="${pageContext.request.userPrincipal.name != 'admin'}">
				<li><a href="<c:url value="/mycart" />">Cart</a>${cartSize}</li>
			</c:if>
		...
		<c:if test="${!empty selectedProduct.name}">
			<table>
				...
				<tr>
					...
					<td><a href="<c:url value='cart/add/${selectedProduct.id}' />"><button type="button" class="btn btn-primary">Add to Cart</button></a></td>
				</tr>
			</table>
		</c:if>
	</div>
...
<div id="myCarousel" class="carousel slide" data-ride="carousel">
  ...
  <div class="carousel-inner" role="listbox">
    <div class="item active">
      <img src="<c:url value="/resources/img/santafe.jpg"/>" alt="car1" width="460" height="345">
    </div>

    <div class="item">
      <img src="<c:url value="/resources/img/benza45.jpg"/>" alt="car2" width="460" height="345">
    </div>

    <div class="item">
      <img src="<c:url value="/resources/img/audia3.jpg"/>" alt="car3" width="460" height="345">
    </div>
