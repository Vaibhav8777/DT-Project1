...
<div class="container">
<div class="login">
<h1 class="text-center login-title">Invalid credentials</h1>
<header class="login-header"><span class="text">LOGIN</span><span class="loader"></span></header>

	<form class="login-form" method="post" action="isValidUser">
		
	<input type="text" placeholder="Username" name="name" class="login-input"/>
